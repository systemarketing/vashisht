...
const HeroSection = () => {
  ...
  const cards = [
    ...
    { icon: Flame, title: "Время перемен", desc: "Даты Душеры. Поездка совпадает с большим фестивалем победы света над тьмой. Идеальный момент для работы над собственными ограничениями." },
