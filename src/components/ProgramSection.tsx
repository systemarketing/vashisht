...
const programs = [
  ...
  },
  {
    ...
    description: "Интерактивные воркшопы с создателем \"Системы\": Ильей Харитоновым. Разберем, как перенести логику дисциплины Аштанги на язык бизнеса: тайм-менеджмент, системный маркетинг и дизайн для личного бренда, организация удаленной работы бизнеса, ответим на вопрос как превращать охваты в соц.сетях в реальную выручку.",
    image: workshopImg,
  },
];
