...
import yogaImg from "@/assets/1449ba46-a505-4d6b-8850-3021e8e85c80.png";
import trekkingImg from "@/assets/trekking.jpg";
import workshopImg from "@/assets/88c3a17c-d085-49f1-9503-78095ecca1b3.png";

const programs = [
  {
    title: "Утро: Практика",
    description: "Каждый день начинается с 9 утренних Майсор-классов Аштанга-йоги под руководством Макса Лапшина. Комфортный зал, прямой контакт с учителем и панорамный вид на заснеженные Гималаи.",
    image: yogaImg,
  },
  {
  ...
  },
  {
    ...
    description: "3 воркшопа с Ильей Харитоновым. Разбираем, как перенести логику дисциплины Аштанги на язык бизнеса: тайм-менеджмент, системный маркетинг для личного продукта и организация удаленной работы из любой точки мира.",
    image: workshopImg,
  },
];
