      ...
      <header className="fixed top-0 left-0 right-0 z-50 bg-background/5 backdrop-blur-xl border-b border-white/10">
        <div className="max-w-6xl mx-auto flex items-center justify-between px-4 h-12">
          ...
          <div className="flex items-center gap-3">
            <a href="https://t.me/max_lapshin" target="_blank" rel="noopener noreferrer" className="hidden md:block text-muted-foreground hover:text-foreground transition-colors">
              <MessageCircle className="w-4 h-4" />
            </a>
            <a href="https://vk.com/im/convo/3768091" target="_blank" rel="noopener noreferrer" className="hidden md:block text-muted-foreground hover:text-foreground transition-colors">
            ...
            <a href="tel:+79056639653" className="hidden md:block text-muted-foreground hover:text-foreground transition-colors">
