          ...
          >
            ...
            <div className="p-8">
              ...
              <div className="flex items-center gap-4 mb-6">
                ...
                <a href="https://vk.com/max_lapshin_ashtanga" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-primary transition-colors">
          ...
          >
            ...
            <div className="p-8">
              ...
              <div className="flex items-center gap-4 mb-6">
                ...
                <a href="https://youtu.be/-JH3TYcRHGc" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-primary transition-colors">
      ...
      <Dialog open={maxOpen} onOpenChange={(open) => { setMaxOpen(open); if (!open) setMaxExpanded(false); }}>
        <DialogContent className="bg-card border-border max-w-3xl max-h-[90vh] overflow-y-auto [&>button]:top-2 [&>button]:right-2 [&>button]:bg-card/80 [&>button]:rounded-full [&>button]:p-1">
          ...
          <div className="flex items-center gap-6 pt-2 flex-wrap">
            ...
            <a href="https://vk.com/max_lapshin_ashtanga" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-muted-foreground hover:text-primary transition-colors text-sm font-body">
